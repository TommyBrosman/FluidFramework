...
import type { CustomizedSchemaTyping, CustomTypes } from "../customSchemaTypes.js";
		...
		// Supporting explicit field schema wrapping CustomizedSchemaTyping here breaks compilation of recursive cases as well.
		{
			...
			readonly [Property in keyof T as [T[Property]] extends [
				...
				? // Inverse of the conditional above: only include readonly fields when not including the readWrite one. This is required to make recursive types compile.
					Property
				: // TODO: This was previously `TreeFieldFromImplicitFieldUnsafe` and has been changed to make the code type-check. It is not necessarily
				  // correct and should be changed back once `TreeFieldFromImplicitFieldUnsafe` is fixed.
					never]: AssignableTreeFieldFromImplicitFieldUnsafe<T[Property]>;
		};
