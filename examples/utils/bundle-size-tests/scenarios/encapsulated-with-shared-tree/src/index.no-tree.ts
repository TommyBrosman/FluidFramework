...
// Same as ./index.ts but with the @fluidframework/tree exports removed,
// to measure the marginal cost of including SharedTree in the bundle.
...
export type { IQuorumSnapshot, IScribeProtocolState } from "@fluidframework/protocol-base";
